...
import { Divider, Grid, Typography, Avatar, Button, Dialog, DialogTitle, DialogContent, DialogActions } from '@mui/material';
      ...
      <Grid container spacing={2} sx={{ marginLeft: 'auto', marginRight: 'auto' }}>
        ...
        <Grid item xs={12} sx={{ display: 'flex', alignItems: 'center', flexDirection: 'row' }}>
          <Grid item xs={6} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
            <Avatar alt="Person" src="/images/user1.jpg" sx={{ width: 200, height: 200, mt: 8, mb: 4,}} />
            ...
            <Button variant="contained" color="primary" onClick={clickEvent} size='large' sx={{ mt: 4 }}>
              신청
            </Button>
          </Grid>
        </Grid>
